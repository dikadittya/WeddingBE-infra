...
CREATE DATABASE IF NOT EXISTS `app_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `app_db`;

-- Dumping structure for table app_db.data_alamat
CREATE TABLE IF NOT EXISTS `data_alamat` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `kode_alamat` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `kd_rumahan` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kd_gedung` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `data_alamat_kode_alamat_unique` (`kode_alamat`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.data_alamat: ~0 rows (approximately)
INSERT INTO `data_alamat` (`id`, `kode_alamat`, `nama_provinsi`, `kode_provinsi`, `nama_kabupaten`, `kode_kabupaten`, `nama_kecamatan`, `kode_kecamatan`, `nama_desa`, `kode_desa`, `jarak`, `kd_rumahan`, `kd_gedung`, `created_at`, `updated_at`) VALUES
	(1, '3525032004', 'Jawa Timur', '35', 'Gresik', '3525', 'Panceng', '3525032', 'Ketanan', '3525032004', 12.75, '1', '1', '2025-12-08 14:31:44', '2025-12-08 14:31:44');

-- Dumping structure for table app_db.data_bunga_melati
CREATE TABLE IF NOT EXISTS `data_bunga_melati` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `jenis` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rincian` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `bouquet` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.data_bunga_melati: ~0 rows (approximately)

-- Dumping structure for table app_db.data_busana
CREATE TABLE IF NOT EXISTS `data_busana` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_tipe_busana` bigint unsigned NOT NULL,
  `tipe_busana` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_kategori` bigint unsigned DEFAULT NULL,
  `nama_busana` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `harga_beli` decimal(15,2) NOT NULL,
  `tanggal_beli` date NOT NULL,
  `produk_by` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `data_busana_id_tipe_busana_foreign` (`id_tipe_busana`),
  CONSTRAINT `data_busana_id_tipe_busana_foreign` FOREIGN KEY (`id_tipe_busana`) REFERENCES `master_tipe_busana` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.data_busana: ~0 rows (approximately)

-- Dumping structure for table app_db.data_busana_kategori
CREATE TABLE IF NOT EXISTS `data_busana_kategori` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table app_db.data_busana_kategori: ~0 rows (approximately)

-- Dumping structure for table app_db.failed_jobs
...
-- Dumping data for table app_db.failed_jobs: ~0 rows (approximately)

-- Dumping structure for table app_db.guests
...
-- Dumping data for table app_db.guests: ~0 rows (approximately)

-- Dumping structure for table app_db.master_item_paket
CREATE TABLE IF NOT EXISTS `master_item_paket` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_jenis` bigint unsigned DEFAULT NULL COMMENT 'ID referensi ke master jenis item paket',
  `nama_item` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nama item paket',
  `tipe` enum('reguler','khusus') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipe paket: reguler atau khusus',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `order_item` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.master_item_paket: ~7 rows (approximately)
INSERT INTO `master_item_paket` (`id`, `id_jenis`, `nama_item`, `tipe`, `created_at`, `updated_at`, `order_item`) VALUES
	(1, 1, 'Make Up Brides', 'reguler', NULL, NULL, 1),
	(2, 1, 'Kebaya/Gown Akad', 'reguler', NULL, NULL, 2),
	(3, 1, 'Kebaya/Gown Resepsi Crown', 'reguler', NULL, NULL, 3),
	(4, 2, 'Pengantin Kecil', 'reguler', NULL, NULL, 4),
	(5, 1, 'Kebaya/Gown Resepsi Ace', 'reguler', '2025-12-08 23:09:45', '2025-12-08 23:09:45', 5),
	(8, 1, 'Make Up Brides', 'reguler', NULL, NULL, 6),
	(9, 1, 'Kebaya/Gown Resepsi Premium', 'reguler', '2025-12-15 05:37:52', '2025-12-15 05:37:52', 7);

-- Dumping structure for table app_db.master_item_paket_harga
CREATE TABLE IF NOT EXISTS `master_item_paket_harga` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_master_item_paket` bigint unsigned NOT NULL COMMENT 'ID referensi ke master item paket',
  `harga` decimal(15,2) NOT NULL COMMENT 'Harga item paket',
  `id_master_mua` bigint unsigned NOT NULL COMMENT 'ID referensi ke master MUA',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Dumping data for table app_db.master_item_paket_harga: ~2 rows (approximately)
INSERT INTO `master_item_paket_harga` (`id`, `id_master_item_paket`, `harga`, `id_master_mua`, `created_at`, `updated_at`, `kategori`) VALUES
	(2, 9, 1500000.00, 1, '2025-12-15 05:37:52', '2025-12-15 05:37:52', 'gedung'),
	(5, 2, 5000000.00, 1, '2025-12-17 17:01:27', '2025-12-17 17:01:27', 'gedung');

-- Dumping structure for table app_db.master_jenis_item_paket
CREATE TABLE IF NOT EXISTS `master_jenis_item_paket` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nama_jenis` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nama jenis item paket',
  `deskripsi` text COLLATE utf8mb4_unicode_ci COMMENT 'Deskripsi jenis item paket',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `order_jenis` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.master_jenis_item_paket: ~5 rows (approximately)
INSERT INTO `master_jenis_item_paket` (`id`, `nama_jenis`, `deskripsi`, `created_at`, `updated_at`, `order_jenis`) VALUES
	(1, 'Make up dan Busana Pengantin', NULL, NULL, NULL, 1),
	(2, 'Make up dan Busana Pendamping', NULL, NULL, NULL, 2),
	(3, 'Dekorasi', NULL, NULL, NULL, 3),
	(4, 'Dokumentasi', NULL, NULL, NULL, 4),
	(5, 'Entertain', NULL, NULL, NULL, 5);

-- Dumping structure for table app_db.master_jobdesc
CREATE TABLE IF NOT EXISTS `master_jobdesc` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `member_kategori_nama_kategori_unique` (`nama`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.master_jobdesc: ~9 rows (approximately)
INSERT INTO `master_jobdesc` (`id`, `nama`, `created_at`, `updated_at`, `is_visible`) VALUES
	(1, 'Admin', '2025-11-01 09:52:59', '2025-11-01 09:52:59', 0),
	(2, 'MUA', '2025-11-01 09:52:59', '2025-11-01 09:52:59', 1),
	(3, 'Asisten', '2025-11-01 09:52:59', '2025-11-01 09:52:59', 1),
	(4, 'Crew', '2025-11-01 09:52:59', '2025-11-01 09:52:59', 1),
	(5, 'Entertain', '2025-11-01 09:52:59', '2025-11-01 09:52:59', 1),
	(6, 'Dokumentasi', '2025-11-01 09:52:59', '2025-11-01 09:52:59', 1),
	(7, 'Dekorasi', '2025-11-01 09:52:59', '2025-11-01 09:52:59', 1),
	(8, 'Properti', '2025-11-01 09:52:59', '2025-11-01 09:52:59', 1),
	(9, 'Lainya', '2025-11-01 09:52:59', '2025-11-01 09:52:59', 1);

-- Dumping structure for table app_db.master_mua
CREATE TABLE IF NOT EXISTS `master_mua` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nama_mua` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nama MUA',
  `is_vendor` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Status vendor: 1 = vendor, 0 = bukan vendor',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.master_mua: ~2 rows (approximately)
INSERT INTO `master_mua` (`id`, `nama_mua`, `is_vendor`, `created_at`, `updated_at`) VALUES
	(1, 'MUA Lusi Rohmah', 0, NULL, NULL),
	(2, 'MUA Beuty LW', 0, NULL, NULL),
	(3, 'Vendor', 1, NULL, NULL);

-- Dumping structure for table app_db.master_tipe_busana
CREATE TABLE IF NOT EXISTS `master_tipe_busana` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nama_tipe_busana` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `master_tipe_busana_nama_tipe_busana_unique` (`nama_tipe_busana`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.master_tipe_busana: ~0 rows (approximately)

-- Dumping structure for table app_db.members
CREATE TABLE IF NOT EXISTS `members` (
  ...
  `is_core_team` tinyint DEFAULT '0',
  `key_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'id Name Personalia',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `member_user_id_foreign` (`user_id`),
  CONSTRAINT `member_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.members: ~10 rows (approximately)
INSERT INTO `members` (`id`, `user_id`, `nama`, `jabatan`, `alamat`, `nomor_hp`, `is_core_team`, `key_name`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Taufiqur Rohman', 'Manager', 'Banyutengah', NULL, 1, 'Taufiq', NULL, NULL),
	(2, 5, 'Luthfiyatin Nisa', 'MUA Lusi Rohman', 'Banyutengah', NULL, 1, 'Lusi Rohman', NULL, '2025-11-28 15:12:37'),
	(3, NULL, 'Fatkhiyatul Mahbubah', 'MUA Beauty LW', 'Banyutengah', NULL, 1, 'Beauty LW', NULL, NULL),
	(4, NULL, 'Yuyun Hidayati', 'Admin 1', 'SIwalan', NULL, 1, 'Yuyun', NULL, NULL),
	(5, NULL, 'Khusnul Khotimah', 'Admin 2', 'Banyutengah', NULL, 1, 'Khusnul', NULL, NULL),
	(6, NULL, 'Aelis Setiawan', 'Asisten MUA', 'Banyutengah', NULL, 1, 'Ail', NULL, NULL),
	(7, NULL, 'Idatul Jannah', NULL, NULL, NULL, 0, 'Idatul Jannah', NULL, NULL),
	(8, NULL, 'Linda', NULL, NULL, NULL, 0, 'Linda', NULL, NULL),
	(9, NULL, 'Yizid', NULL, NULL, NULL, 0, 'Yizid', NULL, NULL),
	(10, NULL, 'Yoga', NULL, NULL, NULL, 0, 'Yoga', NULL, NULL);

-- Dumping structure for table app_db.member_jobdesc
CREATE TABLE IF NOT EXISTS `member_jobdesc` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_member` bigint unsigned NOT NULL,
  `id_jobdesc` bigint unsigned NOT NULL,
  `nama_jobdesc` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Kategori TW',
  `tipe_jobdesc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Jenis TW',
  `key_job` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'id TW',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `member_jobdesc_id_member_foreign` (`id_member`),
  KEY `member_jobdesc_id_jobdesc_foreign` (`id_jobdesc`),
  CONSTRAINT `member_jobdesc_id_jobdesc_foreign` FOREIGN KEY (`id_jobdesc`) REFERENCES `master_jobdesc` (`id`) ON DELETE CASCADE,
  CONSTRAINT `member_jobdesc_id_member_foreign` FOREIGN KEY (`id_member`) REFERENCES `members` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.member_jobdesc: ~8 rows (approximately)
INSERT INTO `member_jobdesc` (`id`, `id_member`, `id_jobdesc`, `nama_jobdesc`, `tipe_jobdesc`, `key_job`, `created_at`, `updated_at`) VALUES
	(1, 2, 2, 'MUA', 'MUA Lusi Rohmah', 'Lusi Rohmah', NULL, NULL),
	(2, 3, 2, 'MUA', 'MUA BLW', 'Beauty LW', NULL, NULL),
	(3, 6, 3, 'Asisten', 'Asisten', 'Ail', NULL, NULL),
	(4, 3, 4, 'Crew', 'Crew', 'F Mahbubah', NULL, NULL),
	(5, 8, 4, 'Crew', 'Crew', 'Linda', NULL, NULL),
	(6, 3, 6, 'Dekorasi', 'Dekorasi', 'Baba_Deco', NULL, NULL),
	(7, 9, 5, 'Entertain', 'MC', 'Yazid', NULL, NULL),
	(8, 10, 5, 'Entertain', 'Sexophone', 'Yoga', NULL, NULL);

-- Dumping structure for table app_db.menus
...
-- Dumping data for table app_db.menus: ~10 rows (approximately)
INSERT INTO `menus` (`id`, `name`, `slug`, `icon`, `url`, `parent_id`, `order`, `is_active`, `created_at`, `updated_at`) VALUES
	(1, 'Dashboard', 'dashboard', 'dashboard', '/dashboard', NULL, 1, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44'),
	(2, 'User Management', 'user-management', 'people', NULL, NULL, 2, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44'),
	(3, 'Users', 'users', 'person', '/users', 2, 1, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44'),
	(4, 'Roles & Permissions', 'roles-permissions', 'security', '/roles-permissions', 2, 2, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44'),
	(5, 'Member Management', 'member-management', 'group', NULL, NULL, 3, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44'),
	(6, 'Members', 'members', 'person_outline', '/members', 5, 1, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44'),
	(7, 'Job Descriptions', 'job-descriptions', 'work', '/job-descriptions', 5, 2, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44'),
	(8, 'Settings', 'settings', 'settings', NULL, NULL, 4, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44'),
	(9, 'Menu Management', 'menu-management', 'menu', '/menu-management', 8, 1, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44'),
	(10, 'System Settings', 'system-settings', 'settings_applications', '/system-settings', 8, 2, 1, '2025-11-26 13:10:44', '2025-11-26 13:10:44');

-- Dumping structure for table app_db.menu_roles
CREATE TABLE IF NOT EXISTS `menu_roles` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `menu_roles_menu_id_role_name_unique` (`menu_id`,`role_name`),
  CONSTRAINT `menu_roles_menu_id_foreign` FOREIGN KEY (`menu_id`) REFERENCES `menus` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.menu_roles: ~20 rows (approximately)
INSERT INTO `menu_roles` (`id`, `menu_id`, `role_name`, `created_at`, `updated_at`) VALUES
	(1, 1, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(2, 1, 'admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(3, 1, 'user', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(4, 2, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(5, 2, 'admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(6, 3, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(7, 3, 'admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(8, 4, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(9, 5, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(10, 5, 'admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(11, 5, 'user', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(12, 6, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(13, 6, 'admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(14, 6, 'user', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(15, 7, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(16, 7, 'admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(17, 8, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(18, 8, 'admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(19, 9, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50'),
	(20, 10, 'super_admin', '2025-11-26 13:10:50', '2025-11-26 13:10:50');

-- Dumping structure for table app_db.migrations
...
-- Dumping data for table app_db.migrations: ~28 rows (approximately)
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	(1, '2014_10_12_000000_create_users_table', 1),
	(2, '2014_10_12_100000_create_password_reset_tokens_table', 1),
	(3, '2019_08_19_000000_create_failed_jobs_table', 1),
	(4, '2019_12_14_000001_create_personal_access_tokens_table', 1),
	(5, '2025_11_21_223830_create_guests_table', 1),
	(6, '2025_11_21_231026_create_casbin_rules_table', 1),
	(7, '2025_11_21_231050_create_user_roles_table', 1),
	(8, '2025_11_21_231102_add_role_to_users_table', 1),
	(9, '2025_11_01_163309_create_master_kategori_table', 2),
	(10, '2025_11_01_180140_create_master_tipe_busana_table', 2),
	(11, '2025_11_01_182649_create_data_busana_table', 2),
	(12, '2025_11_05_151543_create_data_busana_kategori_table', 2),
	(13, '2025_11_05_170517_create_data_bunga_melati_table', 2),
	(14, '2025_11_21_163309_create_member_kategori_table', 3),
	(16, '2025_10_28_215409_create_member_table', 4),
	(17, '2025_11_22_064500_create_master_jobdesc_table', 5),
	(18, '2025_11_22_064600_create_member_jobdesc_table', 6),
	(19, '2025_11_26_070000_create_menus_table', 7),
	(20, '2025_11_26_070100_create_menu_roles_table', 7),
	(21, '2025_11_28_000001_add_username_to_users_table', 8),
	(22, '2025_11_28_010000_add_user_id_to_members_table', 9),
	(23, '2025_11_28_011000_rename_member_table_to_members', 10),
	(24, '2025_12_05_222741_create_data_alamat_table', 11),
	(25, '2025_12_08_223536_create_master_item_paket_table', 12),
	(26, '2025_12_08_223837_create_master_mua_table', 13),
	(27, '2025_12_08_224006_create_master_item_paket_harga_table', 13),
	(28, '2025_12_09_052845_create_master_jenis_item_paket_table', 14),
	(29, '2025_12_09_053117_add_id_jenis_to_master_item_paket_table', 15),
	(32, '2025_12_14_100000_create_master_paket_table', 16),
	(33, '2025_12_14_100001_create_paket_items_table', 16),
	(34, '2025_12_17_233925_drop_kategori_paket_from_master_item_paket_table', 17),
	(35, '2025_12_17_234640_add_id_paket_to_master_item_paket_harga_table', 18),
	(36, '2025_12_18_220557_create_paket_up_table', 18);

-- Dumping structure for table app_db.paket_items
CREATE TABLE IF NOT EXISTS `paket_items` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_paket_master` bigint unsigned NOT NULL,
  `id_master_item_paket` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `volume` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `paket_items_id_paket_master_foreign` (`id_paket_master`),
  CONSTRAINT `paket_items_id_paket_master_foreign` FOREIGN KEY (`id_paket_master`) REFERENCES `paket_master` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.paket_items: ~1 rows (approximately)
INSERT INTO `paket_items` (`id`, `id_paket_master`, `id_master_item_paket`, `created_at`, `updated_at`, `volume`) VALUES
	(1, 1, 1, NULL, NULL, NULL),
	(2, 1, 2, '2025-12-17 17:01:27', '2025-12-17 17:01:27', 3);

-- Dumping structure for table app_db.paket_master
CREATE TABLE IF NOT EXISTS `paket_master` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_mua` bigint unsigned NOT NULL,
  `nama_paket` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nama paket',
  `jenis_paket` enum('gedung','rumahan') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Jenis paket: gedung atau rumahan',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `paket_master_id_mua_foreign` (`id_mua`),
  CONSTRAINT `paket_master_id_mua_foreign` FOREIGN KEY (`id_mua`) REFERENCES `master_mua` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.paket_master: ~0 rows (approximately)
INSERT INTO `paket_master` (`id`, `id_mua`, `nama_paket`, `jenis_paket`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Paket Wedding Gedung Premium', 'gedung', '2025-12-14 05:35:50', '2025-12-14 05:35:50');

-- Dumping structure for table app_db.paket_up
CREATE TABLE IF NOT EXISTS `paket_up` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `jenis_up` enum('gedung','rumahan') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Jenis UP: gedung atau rumahan',
  `id_jenis_item_paket` bigint unsigned NOT NULL COMMENT 'Foreign key ke master_jenis_item_paket',
  `kode_area` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Kode area/wilayah',
  `nilai_up` decimal(15,2) NOT NULL COMMENT 'Nilai UP dalam rupiah',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `paket_up_jenis_up_kode_area_index` (`jenis_up`,`kode_area`),
  KEY `paket_up_id_jenis_item_paket_index` (`id_jenis_item_paket`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.paket_up: ~0 rows (approximately)
INSERT INTO `paket_up` (`id`, `jenis_up`, `id_jenis_item_paket`, `kode_area`, `nilai_up`, `created_at`, `updated_at`) VALUES
	(1, 'gedung', 3, 'Area 1', 1500000.00, '2025-12-18 15:23:41', '2025-12-18 15:23:41');

-- Dumping structure for table app_db.password_reset_tokens
...
-- Dumping data for table app_db.password_reset_tokens: ~0 rows (approximately)

-- Dumping structure for table app_db.personal_access_tokens
...
-- Dumping data for table app_db.personal_access_tokens: ~25 rows (approximately)
INSERT INTO `personal_access_tokens` (`id`, `tokenable_type`, `tokenable_id`, `name`, `token`, `abilities`, `last_used_at`, `expires_at`, `created_at`, `updated_at`) VALUES
	(1, 'App\\Models\\User', 1, 'auth_token', 'd0852a0409702eae0d38f925cd99417643f92773eaf260a7fed44c302573b5e4', '["*"]', NULL, NULL, '2025-11-21 16:45:45', '2025-11-21 16:45:45'),
	(2, 'App\\Models\\User', 1, 'auth_token', 'ef667ff285c3e2b31e0dd7712ca64f0c5df7d50f113912d67af29fe125392736', '["*"]', NULL, NULL, '2025-11-21 16:48:43', '2025-11-21 16:48:43'),
	(3, 'App\\Models\\User', 1, 'auth_token', '58a8ab94d17511366b723e4f48305b99ff08ff4a292fa0f5fa5e64caea423dc1', '["*"]', '2025-11-22 01:30:59', NULL, '2025-11-21 16:49:16', '2025-11-22 01:30:59'),
	(4, 'App\\Models\\User', 1, 'auth_token', 'd65a962b34cccd3459701879d1ce4587159c0090eb1870f66dc211cf41e7bd0b', '["*"]', '2025-11-24 14:53:05', NULL, '2025-11-24 14:39:24', '2025-11-24 14:53:05'),
	(5, 'App\\Models\\User', 1, 'auth_token', 'e7b2939dbc13446d7409a8cd49ffd4db1c87e4e7ed20a5a2108db339f2853896', '["*"]', '2025-11-24 14:55:59', NULL, '2025-11-24 14:55:48', '2025-11-24 14:55:59'),
	(6, 'App\\Models\\User', 1, 'auth_token', 'd67d633844a3e66ce298117412e6ad018bfd7d92161743ca86c6dbccb49b8132', '["*"]', '2025-11-24 14:59:15', NULL, '2025-11-24 14:58:51', '2025-11-24 14:59:15'),
	(7, 'App\\Models\\User', 1, 'auth_token', '47180f18ea3706f457f12ab4d23a2bef6ddb17fd2f2aa7be28b4c535b102390a', '["*"]', '2025-11-24 15:01:21', NULL, '2025-11-24 15:00:29', '2025-11-24 15:01:21'),
	(8, 'App\\Models\\User', 1, 'auth_token', '0e33ff776274a1921bbe09f0af19a748043f41ec1cf0d205110a47ece332ebd2', '["*"]', '2025-11-24 15:06:22', '2025-11-24 15:06:23', '2025-11-24 15:04:23', '2025-11-24 15:06:22'),
	(9, 'App\\Models\\User', 1, 'auth_token', '4dd97b2ee06c47327c5ac61d46200ce69a0213009f513bcf238c57a082a04521', '["*"]', '2025-11-24 15:07:48', '2025-11-24 15:09:03', '2025-11-24 15:07:03', '2025-11-24 15:07:48'),
	(10, 'App\\Models\\User', 1, 'auth_token', '38fb37b8dfbaac685956df7f4b7cb07b8a5c492d218714e769c26ac2e0cbb99e', '["*"]', '2025-11-24 15:24:55', '2025-11-24 15:30:41', '2025-11-24 15:10:45', '2025-11-24 15:24:55'),
	(11, 'App\\Models\\User', 1, 'auth_token', 'b922bdb45f3ec6df0a47ae64844c704c557bae98d2fb4ee7db7737a3c8895340', '["*"]', '2025-11-25 21:51:11', '2025-11-25 22:04:36', '2025-11-25 21:48:50', '2025-11-25 21:51:11'),
	(12, 'App\\Models\\User', 1, 'auth_token', '0328357f8e43bef10568b0890f9e4e47432df0d9fa34e77d69ef7454e7151418', '["*"]', NULL, '2025-11-25 22:24:36', '2025-11-25 22:09:36', '2025-11-25 22:09:36'),
	(13, 'App\\Models\\User', 1, 'auth_token', 'ef16f22e7e82ffed6ac2156807509ffdf2e27749fb2b52c0dcb65780cdf93188', '["*"]', '2025-11-26 13:43:29', '2025-11-26 13:44:34', '2025-11-26 13:29:34', '2025-11-26 13:43:29'),
	(14, 'App\\Models\\User', 1, 'auth_token', '83e416a4911a427ba43d011ced0ac554bf6a1337489ec0991da4d05e5e5e61f4', '["*"]', '2025-11-26 13:52:56', '2025-11-26 14:00:31', '2025-11-26 13:45:31', '2025-11-26 13:52:56'),
	(15, 'App\\Models\\User', 1, 'auth_token', 'ae4c95c37784faae4f93e4a2e58b1136ee7fd18d0e69120b07c2391e07696320', '["*"]', '2025-11-26 14:07:10', '2025-11-26 14:22:07', '2025-11-26 14:07:07', '2025-11-26 14:07:10'),
	(16, 'App\\Models\\User', 1, 'auth_token', 'de40c7d595c9d6fd61198fea94b67c4e1649c9232bc68f02237467d40db16b26', '["*"]', '2025-11-28 14:37:45', '2025-11-28 14:51:39', '2025-11-28 14:36:39', '2025-11-28 14:37:45'),
	(17, 'App\\Models\\User', 1, 'auth_token', '12a44bc430448680b57e52ee91d2750ff0bc6dc11f0890f001cfdf7f56adaa72', '["*"]', '2025-11-28 14:58:43', '2025-11-28 15:08:06', '2025-11-28 14:53:06', '2025-11-28 14:58:43'),
	(18, 'App\\Models\\User', 1, 'auth_token', '6b72540dd3c3b25d409308cf08a44e79af61be231089aa9be6d659f430d68216', '["*"]', '2025-11-28 15:12:36', '2025-11-28 15:23:57', '2025-11-28 15:08:57', '2025-11-28 15:12:36'),
	(19, 'App\\Models\\User', 5, 'auth_token', '7cf90c5392507c413bbcc8c0df30d107779057cb006cdd1992d1167d0705ec80', '["*"]', NULL, '2025-11-28 15:28:29', '2025-11-28 15:13:29', '2025-11-28 15:13:29'),
	(20, 'App\\Models\\User', 1, 'auth_token', 'bf8988428020dc4a4a7e536f9000add41d71dc540dd7013a0f2eab9325a42e0c', '["*"]', '2025-11-28 15:20:22', '2025-11-28 15:28:43', '2025-11-28 15:13:43', '2025-11-28 15:20:22'),
	(21, 'App\\Models\\User', 1, 'auth_token', 'aa33653c21fb974597b12c9e8b5e8aa0e489ae2fce65787d52c77c3c6b14af7b', '["*"]', '2025-11-28 15:25:48', '2025-11-28 15:36:27', '2025-11-28 15:21:27', '2025-11-28 15:25:48'),
	(22, 'App\\Models\\User', 1, 'auth_token', '762f71332440f77ddc138119800e1d737e102b66b552686a8ff9402200bc940f', '["*"]', NULL, '2025-11-29 19:02:18', '2025-11-29 18:47:18', '2025-11-29 18:47:18'),
	(23, 'App\\Models\\User', 1, 'auth_token', '81a76fd7e11a69050ef90f9b7551ecb3f817a69e2ae2e1e160354d8a81d1019b', '["*"]', '2025-11-29 20:35:07', '2025-11-29 20:48:19', '2025-11-29 20:33:19', '2025-11-29 20:35:07'),
	(24, 'App\\Models\\User', 1, 'auth_token', '648e407886ac7044a928ff384f821867f407c422028f4a06f92679f8ea566f64', '["*"]', NULL, '2025-11-29 20:57:50', '2025-11-29 20:42:50', '2025-11-29 20:42:50'),
	(25, 'App\\Models\\User', 1, 'auth_token', '0a415c0e0ede39198e1e6e83f5ccbc0a0cae00386236dc877f728fafbf20d248', '["*"]', '2025-11-29 21:11:54', '2025-11-29 21:14:32', '2025-11-29 20:59:32', '2025-11-29 21:11:54');

-- Dumping structure for table app_db.reg_districts
...
-- Dumping data for table app_db.reg_districts: ~7.342 rows (approximately)
...
-- Dumping structure for table app_db.reg_provinces
CREATE TABLE IF NOT EXISTS `reg_provinces` (
  `id` int DEFAULT NULL,
  `name` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- Dumping data for table app_db.reg_provinces: ~37 rows (approximately)
...
-- Dumping structure for table app_db.reg_regencies
...
-- Dumping data for table app_db.reg_regencies: ~514 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  CONSTRAINT `users_role_foreign` FOREIGN KEY (`role`) REFERENCES `user_roles` (`name`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table app_db.users: ~4 rows (approximately)
INSERT INTO `users` (`id`, `name`, `username`, `email`, `role`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Super Admin', 'superadmin', 'superadmin@wedding.com', 'super_admin', '2025-11-21 16:29:52', '$2y$12$5JVEU.KRfRmyjRdPjFIoIuuEYbOF3UtOmf4xRa./Snz.w9P.mXQ5u', NULL, '2025-11-21 16:29:53', '2025-11-21 16:29:53'),
	(2, 'Admin Wedding', 'admin', 'admin@wedding.com', 'admin', '2025-11-21 16:29:53', '$2y$12$3qyTDGol2OMiM.njxJQPs.DHMZa9vY1xbKbGaLzDlLngUwgqILGd.', NULL, '2025-11-21 16:29:53', '2025-11-21 16:29:53'),
	(3, 'Guest User', 'guest', 'guest@wedding.com', 'guest', '2025-11-21 16:29:53', '$2y$12$h8c4guVmPbN2r9YGSffaP.jTim/vwTWeE/tDDKhfvC0HE/6PL0b.q', NULL, '2025-11-21 16:29:53', '2025-11-21 16:29:53'),
	(5, 'Luthfiyatin Nisa', 'new_username_123', 'rina@example.com', 'super_admin', NULL, '$2y$12$Nzke4jq7MMm7tG8PI2f29uvL2D5t5OA6psKoY/mwCW2vVsZT3mwfe', NULL, '2025-11-28 15:12:37', '2025-11-28 15:25:49');

-- Dumping structure for table app_db.user_casbin_rules
CREATE TABLE IF NOT EXISTS `user_casbin_rules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table app_db.user_casbin_rules: ~68 rows (approximately)
INSERT INTO `user_casbin_rules` (`id`, `ptype`, `v0`, `v1`, `v2`, `v3`, `v4`, `v5`, `created_at`, `updated_at`) VALUES
	(1, 'p', 'super_admin', 'users', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(2, 'p', 'super_admin', 'users', 'POST', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(3, 'p', 'super_admin', 'users', 'PUT', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(4, 'p', 'super_admin', 'users', 'PATCH', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(5, 'p', 'super_admin', 'users', 'DELETE', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(6, 'p', 'super_admin', 'guests', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(7, 'p', 'super_admin', 'guests', 'POST', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(8, 'p', 'super_admin', 'guests', 'PUT', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(9, 'p', 'super_admin', 'guests', 'PATCH', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(10, 'p', 'super_admin', 'guests', 'DELETE', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(11, 'p', 'super_admin', 'weddings', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(12, 'p', 'super_admin', 'weddings', 'POST', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(13, 'p', 'super_admin', 'weddings', 'PUT', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(14, 'p', 'super_admin', 'weddings', 'PATCH', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(15, 'p', 'super_admin', 'weddings', 'DELETE', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(16, 'p', 'admin', 'users', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(17, 'p', 'admin', 'guests', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(18, 'p', 'admin', 'guests', 'POST', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(19, 'p', 'admin', 'guests', 'PUT', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(20, 'p', 'admin', 'guests', 'PATCH', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(21, 'p', 'admin', 'guests', 'DELETE', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(22, 'p', 'admin', 'weddings', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(23, 'p', 'admin', 'weddings', 'POST', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(24, 'p', 'admin', 'weddings', 'PUT', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(25, 'p', 'admin', 'weddings', 'PATCH', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(26, 'p', 'user', 'users', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(27, 'p', 'user', 'guests', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(28, 'p', 'user', 'guests', 'POST', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(29, 'p', 'user', 'weddings', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(30, 'p', 'guest', 'weddings', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:33', '2025-11-22 01:38:33'),
	(31, 'p', 'guest', 'guests', 'GET', NULL, NULL, NULL, '2025-11-22 01:38:34', '2025-11-22 01:38:34'),
	(32, 'p', 'super_admin', 'users', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:36', '2025-11-26 13:31:36'),
	(33, 'p', 'super_admin', 'users', 'POST', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(34, 'p', 'super_admin', 'users', 'PUT', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(35, 'p', 'super_admin', 'users', 'PATCH', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(36, 'p', 'super_admin', 'users', 'DELETE', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(37, 'p', 'super_admin', 'menus', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(38, 'p', 'super_admin', 'menus', 'POST', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(39, 'p', 'super_admin', 'menus', 'PUT', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(40, 'p', 'super_admin', 'menus', 'PATCH', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(41, 'p', 'super_admin', 'menus', 'DELETE', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(42, 'p', 'super_admin', 'guests', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(43, 'p', 'super_admin', 'guests', 'POST', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(44, 'p', 'super_admin', 'guests', 'PUT', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(45, 'p', 'super_admin', 'guests', 'PATCH', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(46, 'p', 'super_admin', 'guests', 'DELETE', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(47, 'p', 'super_admin', 'weddings', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(48, 'p', 'super_admin', 'weddings', 'POST', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(49, 'p', 'super_admin', 'weddings', 'PUT', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(50, 'p', 'super_admin', 'weddings', 'PATCH', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(51, 'p', 'super_admin', 'weddings', 'DELETE', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(52, 'p', 'admin', 'users', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(53, 'p', 'admin', 'menus', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(54, 'p', 'admin', 'guests', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(55, 'p', 'admin', 'guests', 'POST', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(56, 'p', 'admin', 'guests', 'PUT', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(57, 'p', 'admin', 'guests', 'PATCH', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(58, 'p', 'admin', 'guests', 'DELETE', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(59, 'p', 'admin', 'weddings', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(60, 'p', 'admin', 'weddings', 'POST', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(61, 'p', 'admin', 'weddings', 'PUT', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(62, 'p', 'admin', 'weddings', 'PATCH', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(63, 'p', 'user', 'users', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(64, 'p', 'user', 'guests', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(65, 'p', 'user', 'guests', 'POST', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(66, 'p', 'user', 'weddings', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(67, 'p', 'guest', 'weddings', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(68, 'p', 'guest', 'guests', 'GET', NULL, NULL, NULL, '2025-11-26 13:31:37', '2025-11-26 13:31:37'),
	(70, 'p', 'super_admin', 'data-busana', 'GET', NULL, NULL, NULL, '2025-11-29 21:10:04', '2025-11-29 21:10:04');

-- Dumping structure for table app_db.user_roles
...
-- Dumping data for table app_db.user_roles: ~2 rows (approximately)
INSERT INTO `user_roles` (`id`, `name`, `display_name`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'super_admin', 'Super Admin', 'Full access to all resources and system settings', '2025-11-21 16:22:00', '2025-11-21 16:22:00'),
	(2, 'admin', 'Admin', 'Can manage weddings and guests', '2025-11-21 16:22:00', '2025-11-21 16:22:00'),
	(3, 'guest', 'Guest', 'Read-only access to wedding information', '2025-11-21 16:22:00', '2025-11-21 16:22:00');
